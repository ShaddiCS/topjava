...
public class MealTestData {
    ...
    public static final LocalDate START_DATE = LocalDate.of(2015, 6, 1);
    public static final LocalDate END_DATE = LocalDate.of(2015, 6, 3);

    public static final Meal TEST_MEAL = new Meal(MEAL_ID, LocalDateTime.of(2020, Month.JANUARY, 30, 10, 0), "Завтрак", 500);
    ...
    public static Meal getUpdated() {
        Meal updated = new Meal(TEST_MEAL);
